# to create data input files figureA4_3_1_04.csv  and figureA4_3_0_04.csv  for figure A4 in the appendix
...
# here event data are  as in 1981-1990
...
write.csv(as.data.frame(data), "figureA4_3_0_04.csv", row.names=F)
...
write.csv(as.data.frame(means), "figureA4_3_1_04.csv", row.names=F)
