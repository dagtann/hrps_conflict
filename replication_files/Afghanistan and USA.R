...
dataMongol <- subset(data1,  country == "Afghanistan" & YEAR>=1949 & YEAR<=2010)
...
plot(point.estimates, ylim=c(-4.0,4.0), yaxt="n", xaxt="n", pch=19, col="lightsteelblue4", xlab="", ylab="")
...
legend(x=-1, y=3.9, legend=c("Afghanistan"), bty="n", cex=1.4)
