# to create file figureA5_2_04_csv

# for Figure in the Appendix replacing actual values of CIRI ONLY with yet anotehr alternatively calculated random values - random 0, 1 or 2
...
#read "transformed" data, with randome variables replacing real values of CIRI data with random 0, 1 or 2
#data <- read.csv("FakeCIRI_InputDataFariss1949_2010Transformed.csv")


data <- read.csv("Fake_CIRI_FarissAPSRData1949_2010_prepared_for_analysis_04.csv")
...
write.csv(as.data.frame(all.data), "figureA5_2_04.csv", row.names=F)
