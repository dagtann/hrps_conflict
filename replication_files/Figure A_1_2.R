...
page1 <- c(40,  140 , 160 , 90, 91, 92, 93,  135,145  ) #Latin America

page2 <- c(200, 220,210 , 360, 310, 290,   235,  230 ,339) #Europe
page3 <- c( 516,482, 484, 490, 500,  437, 438, 483,501) #Africa
page4 <- c(    ) #Africa

page5 <- c(  666,  700,   780,  800, 811,  850, 651, 660, 840) #Asia

pagex <- c(  315,433,450, 451, 471, 510,630, 790, 678,541, 517, 520, 552,  571    )
