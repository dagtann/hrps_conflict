# to create data input files figureA4_2_1_04.csv  and figureA4_2_0_04.csv  for figure A4 in the appendix

# there are four blocks of new stardard random data;
# each block is 10 years
# here event data are  as in 1991-2000
...
write.csv(as.data.frame(data), "figureA4_2_0_04.csv", row.names=F)
...
write.csv(as.data.frame(means), "figureA4_2_1_04.csv", row.names=F)
